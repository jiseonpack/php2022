    ...
    <main id="contents">
        ...
        <section id="blog-type" class="section center">
            <div class="container">
                ...
                <p class="section__desc">여행에 관련된 블로그입니다. 다양한 정보를 확인하세요!</p>
                ...
                <?php
                    ...
                    $sql = "SELECT blogID, blogTitle, blogContents, blogCategory, blogRegTime, blogImgFile, blogView FROM myBlog WHERE blogTitle LIKE '%{$searchKeyword}%' OR blogContents LIKE '%{$searchKeyword}%' ORDER BY blogID DESC";
                ...
                ?>
                    ...
                    <div class="blog__pages">
                        <ul>
                        <?php
                            $sql = "SELECT blogID, blogTitle, blogContents, blogRegTime, blogView FROM myBlog WHERE blogTitle LIKE '%{$searchKeyword}%' OR blogContents LIKE '%{$searchKeyword}%' ORDER BY blogID DESC";
                            ...
                            if($page != 1){
                                $prePage = $page - 1;
                                echo "<li><a href='blogSearch.php?page={$prePage}&searchKeyword={$searchKeyword}'>>&lt;</a></li>";
                            }
                            ...
                            //마지막 페이지
                            if($count != 0 && $page != $count){
                                echo "<li><a href='blogSearch.php?page={$count}&searchKeyword={$searchKeyword}'>&gt;&gt;</a></li>";
                            }
                        ?>
                        </ul>
                    </div>
